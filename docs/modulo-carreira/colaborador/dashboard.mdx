...
**Diagnóstico:** Colaborador sem entrada unificada = contexto fragmentado = abandono.

[Ler: Problema & diagnóstico](./dashboard/problema-diagnostico.mdx)

---

### 🏗️ Como funciona
**Arquitetura:** C4 Model (contexto, containers, componentes), fluxos de dados, padrões.

[Ler: Arquitetura & solução](./dashboard/arquitetura-solucao.mdx)

---

### 📊 Como validar
**Hipóteses:** Tempo reduzido, recorrência semanal, feedback loop, próximos passos geram conclusão.

[Ler: Validação & métricas](./dashboard/validacao-metricas.mdx)

---

### 🎨 Prototipo & componentes
**Inventário:** Textos literais, cores, componentes, mockup.

[Ler: Referência do protótipo](./dashboard/referencia-prototipo.mdx)

---

### ✅ Contrato funcional
**PRD:** Requisitos funcionais, não funcionais, critérios de aceite, Gherkin.

[Ler: Decisões & validação](./dashboard/decisoes-validacao.mdx)
